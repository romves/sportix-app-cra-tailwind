...
const Hero = ({welcome}) => {
  return (
    <div className='flex h-[768px] w-full justify-center text-center items-center'>
      ...
      <p className='text-primary-400 h4-nor'>Selamat datang {welcome.name} !</p>
        ...
        <div className='flex w-[600px] justify-between'>
          ...
          <NavButton rute='/cariteman' label="Teman"><img src={fren} alt="lap" className='rounded-full object-cover'/></NavButton>

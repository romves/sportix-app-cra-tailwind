...
const CoachCard = () => {
  return (
    <div className='w-[240px] h-[350px] bg-orange-500 mx-1 rounded-xl'>
        <img className='rounded-t-xl h-[210px] w-[240px] object-cover' src="https://petapixel.com/assets/uploads/2022/09/SportsPhotographerBasketball3-800x800.jpeg" alt="" />
        <div className='p-2'>
